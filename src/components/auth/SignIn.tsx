...
const SignIn = () => {
    ...
    const onSubmit = async (data: SignUpFormValues) => {
        setLoading(true);
        try {
            const endpoint = "https://my-app-cjm8.onrender.com/api/users/register";
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100">
            <div className={`w-full bg-gray-100 overflow-hidden flex flex-col md:flex-row h-screen`}>
                ...
                <div className="w-full md:w-1/2 p-8 md:p-10 flex flex-col my-auto">
                    ...
                    {isSignIn ? <form onSubmit={handleSubmitSignIn(onSubmitSignIn)} className="space-y-4">
                        {/* EMAIL */}
                        <InputField
                            label="Email"
                            type="text"
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
                            ...
                            <button type="submit" className="w-full py-2 bg-orange-600 text-white rounded-lg cursor-pointer">
                                Sign Up
                            </button>
                        </form>}
